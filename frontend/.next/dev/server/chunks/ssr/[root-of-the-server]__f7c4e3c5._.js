...
const Login = ()=>{
    ...
    const handleLogin = async (e)=>{
        ...
        if (error) {
            ...
            if (user) {
                const { data: profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').select('id').eq('id', user.id).single();
                if (!profile) {
                    // Profile missing, create it now
                    const username = user.user_metadata?.username || user.email?.split('@')[0] || 'User';
                    const { error: insertError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('users').insert([
                        {
                            id: user.id,
                            username: username,
                            rating: 1000
