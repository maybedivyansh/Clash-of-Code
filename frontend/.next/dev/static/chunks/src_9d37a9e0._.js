...
const AuthProvider = ({ children })=>{
        ...
        "AuthProvider.useEffect": ()=>{
            ...
            const getSession = {
                "AuthProvider.useEffect.getSession": async ()=>{
                    try {
                        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
                        if (error) throw error;
                        const sessionUser = data?.session?.user ?? null;
                        setUser(sessionUser);
                        // Self-healing: Ensure profile exists for existing session
                        if (sessionUser) {
                            const { data: profile } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').select('id').eq('id', sessionUser.id).single();
                            if (!profile) {
                                const username = sessionUser.user_metadata?.username || sessionUser.email?.split('@')[0] || 'User';
                                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('users').insert([
                                    {
                                        id: sessionUser.id,
                                        username: username,
                                        rating: 1000
    ...
    const loginAsGuest = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
    ...
    const getActiveUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[getActiveUser]": ()=>{
            if (user) {
                return {
                    id: user.id,
            ...
            if (!currentGuestId && ("TURBOPACK compile-time value", "object") !== 'undefined') {
...
_s(AuthProvider, "asbuOabj3GWPoWtdreFuyILUM9E=");
_c = AuthProvider;
const useAuth = ()=>{
    _s1();
...
//# sourceMappingURL=src_9d37a9e0._.js.map